...
#The script downloads the homepage of VentureBeat, and if it finds some text, emails me.
...
while True:
    ...
    # but if the word "Google" occurs any other number of times,
        ...
        fromaddr = 'wyckliffe@culturebiosciences.com'
        # set the 'to' addresses,
        toaddrs  = ['madualuga@gmail.com']
